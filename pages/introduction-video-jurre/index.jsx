  ...
  useEffect(() => {
    ...
    script.innerHTML = `
      (function (v, i, d, a, l, y, t, c, s) {
          y='_'.concat(d.toLowerCase());c=d+'L';if(!v[d]){v[d]={};}if(!v[c]){v[c]={};}if(!v[y]){v[y]={};}var vl='Loader',vli=v[y][vl],vsl=v[c][vl + 'Script'],vlf=v[c][vl + 'Loaded'],ve='Embed';
      ...
      })(window, document, 'Vidalytics', 'vidalytics_embed_gXoYLcyLlBE3pCB_', 'https://fast.vidalytics.com/embeds/jHQdYB2g/gXoYLcyLlBE3pCB_/');
    `;
  ...
  return (
    <>
      ...
      <Layout>
        ...
        <div>
          <div
            className="text-[#fff] pt-3 font-bold text-center leading-tight text-xl px-2 sm:px-0 xs:text-3xl sm:text-xl lg:text-4xl w-full max-w-[800px] mx-auto"
            style={{
              position: "relative",
              zIndex: 1,
          ...
          >
            The Smartest Way Of 2025 To Grow 10,000s Of Fans And Build A
            Sustainable Career In Music Without Risking Your Catalog
          </div>
          <br />
          ...
          >
            <div
              id="vidalytics_embed_gXoYLcyLlBE3pCB_"
              style={{
                width: "100%",
                maxWidth: "800px",
                minWidth: "0",
...
export default AffiliateLanding2;
