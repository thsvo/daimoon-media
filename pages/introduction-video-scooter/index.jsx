...
import styles from '/pages/introduction-video-scooter/affiliateHero.module.scss';
...
const AffiliateLanding = (props) => {
  ...
  useEffect(() => {
    ...
    if (document.getElementById('vidalytics-script')) return;

    const script = document.createElement('script');
    script.id = 'vidalytics-script';
    ...
    script.innerHTML = `
      ...
      })(window, document, 'Vidalytics', 'vidalytics_embed__RqtISwn23ClNDlE', 'https://fast.vidalytics.com/embeds/jHQdYB2g/_RqtISwn23ClNDlE/');
    `;
  ...
  return (
    <>
      ...
      The Smartest Way Of 2025 To Grow 10,000s Of Fans And Build A Sustainable Career In Music Without Risking Your Catalog
          ...
          >
            <div
              id="vidalytics_embed__RqtISwn23ClNDlE"
              style={{
                width: '100%',
                maxWidth: '800px',
                minWidth: '0',
