  ...
  return (
    <Layout>
      ...
      <div className={['wrapper', 'column'].join(' ')}>
        ...
        <p>
          Your privacy is important to us. It is DaimoonMarket’s policy to
          respect your privacy regarding any information we may collect from you
          across our website, <a href='https://daimoon.market'>DaimoonMarket</a>
        ...
        <p>
          ...
          Netherlands, Ireland and Germany, or where we or our partners,
          affiliates and third-party providers maintain facilities. By providing
          us with your personal information, you consent to the disclosure to
        ...
        <p>
          <b>Choice and consent: </b>By providing personal information to us,
          you consent to us collecting, holding, using and disclosing your
        ...
        <p>
          ...
          your personal information. If you have previously agreed to us using
        ...
        <p>
          <b>Access and data portability:</b> You may request details of the
          personal information that we hold about you. You may request a copy of
        ...
        <p>
          <b>Notification of data breaches:</b> We will comply laws applicable
          to us in respect of any data breach.
        </p>
        <p>
          <b>Data Deletion:</b> If you wish to request the deletion of your
          personal data, please contact us at support@daimoon.media. Include
          your name and the specific data you wish to have deleted. We will
          respond to your request promptly and ensure the removal of your data
          from our records where required by applicable law.
        </p>
        <p>
